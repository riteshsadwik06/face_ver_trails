class Config(object):
    ...
    train_root = '/content/drive/MyDrive/FaceVerCompi/arcface-pytorch/ES_FaceMatch_Dataset/dataset_images'
    # train_list = '/data/Datasets/webface/train_data_13938.txt'
    # val_list = '/data/Datasets/webface/val_data_13938.txt'
    train_list = '/content/drive/MyDrive/FaceVerCompi/arcface-pytorch/train_ids.csv'
